<template>
  <div>
    ...
    <!--<el-form :inline="true" :model="editDataP" :rules="rules" label-width="140px" ref="editDataP" class="demo-form-inline">-->
    ...
    <!--<el-form-item label="cron" prop="like">-->
    <!--<cron v-model="editDataP.cron"></cron>-->
    <!--</el-form-item>-->
    <!--<el-form-item label="cron2" prop="like">-->
    <!--<cron v-model="editDataP.cron2"></cron>-->
    <!--</el-form-item>-->
    <!--</el-form>-->
    <!--<p class="pop_btn">-->
...
<script type="text/javascript">
  ...
  import {add2,edit2,del2,getList2} from '../../../api/index.js'
    ...
    data() {
      return {
        ...
        editDataP: {
          ...
          age:22,
          like:'黄景瑜',
          cron:'00,22 * 1-2 ? 5 2L 2000-2001',
          cron2:'00,22 * 1-2 ? 5 2L 2000-2001'
        },
        rules: {},
        addEdit: false,
        operateId:null,
    ...
    methods: {
      ...
      save(val) {
        this.$refs[val].validate((valid) => {
          if (valid) {
            console.log('this.editDataP',this.editDataP)
            // let params = this.editDataP;
            // params._id=this.operateId;
            // if (this.operateType === 'add') {
            //   add2(this,params).then(res => {
            //     this.init();
            //     this.addEdit = false;
            //     this.$message({type: 'success', message: '添加成功'});
            //   }).catch(err=>{})
            // } else if (this.operateType === 'edit') {
            //   edit2(this,params).then(res => {
            //     this.init();
            //     this.addEdit = false;
      ...
      del(item) {
        ...
        confirm(that, '确定删除吗？', function () {
          del2(that,{_id:item._id}).then(res => {
            that.init();
